  ...
  for (const item of target) {
    ...
    await prisma.controls.create({
      data: {
        ...
        userContext: idx % 2 === 0 ? "Company context: SaaS product, small team, cloud-first." : null,
        evidenceDescription: idx % 4 === 0 ? "Evidence: policy doc, screenshots, tickets, logs." : null,
